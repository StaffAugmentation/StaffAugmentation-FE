...
export class AddEditScComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.colsPerformance = [
      { field: 'action', header: ' ',width:'350px' },
      { field: 'month', header: 'Month',width:'120px' },
      { field: 'forecast', header: 'Forecast',width:'120px' },
      { field: 'daysWorked', header: 'Days worked',width:'120px' },
      { field: 'remainingDays', header: 'Remaining days',width:'140px' },
      { field: 'oerpProjectCode', header: 'OERP project code',width:'160px' },
      { field: 'company', header: 'Company',width:'120px' },
      { field: 'typeOfContract', header: 'Type of contract',width:'160px' },
      { field: 'consultantCost', header: 'Consultant cost' ,width:'160px'},
      { field: 'thirdPartyRate', header: 'Third party rate' ,width:'160px'},
      { field: 'noInvoiceableDays', header: 'No invoiceable days' ,width:'180px'},
      { field: 'noPayableDays', header: 'No payable days' ,width:'160px'},
      { field: 'paymentStatus', header: 'Payment status' ,width:'160px'},
      { field: 'thirdPartyPaymentStatus', header: 'Third party payment status' ,width:'220px'},
      { field: 'mfPaymentStatus', header: 'MF payment status' ,width:'160px'},
      { field: 'invoicingStatus', header: 'Invoicing status' ,width:'160px'},
      { field: 'mfInvoicingStatus', header: 'MF invoicing status' ,width:'160px'},
    ];
